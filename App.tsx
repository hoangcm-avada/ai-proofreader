...
import { Suggestion, GitBookPage, AnalysisResult, SummaryResult } from './types.ts';
import { proofreadText, summarizeText, initializeGemini } from './services/geminiService.ts';
import { getPageContent } from './services/gitbookService.ts';
import { getGoogleDocContent } from './services/googleDocService.ts';

import { DEMO_MARKDOWN_TEXT, DEFAULT_API_KEY } from './constants.ts';
import { KeyIcon, BookOpenIcon, CheckCircleIcon, ExclamationTriangleIcon, PencilSquareIcon, CloudArrowUpIcon, QuestionMarkCircleIcon, DocumentTextIcon, ListBulletIcon } from './components/icons.tsx';
import Loader from './components/Loader.tsx';
import ProofreadingResults from './components/ProofreadingResults.tsx';
import TextInputView from './components/DemoView.tsx';
import GitBookView from './components/GitBookView.tsx';
import FileUploadView from './components/FileUploadView.tsx';
import GoogleDocView from './components/GoogleDocView.tsx';
import HelpModal from './components/HelpModal.tsx';
import BatchResultsSummary from './components/BatchResultsSummary.tsx';
import SummarizeView from './components/SummarizeView.tsx';
import SummaryResultsView from './components/SummaryResultsView.tsx';
