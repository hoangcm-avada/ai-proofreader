...
export const CheckCircleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-green-400 mx-auto" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>
);

export const ExclamationTriangleIcon = (props: React.SVGProps<SVGSVGElement>) => (
     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-red-400 mx-auto" {...props}>
...
export const FolderOpenIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75h16.5m-16.5 0a2.25 2.25 0 0 1-2.25-2.25V5.25A2.25 2.25 0 0 1 3.75 3h5.25a2.25 2.25 0 0 1 1.59.659l2.122 2.121c.14.141.331.22.53.22H19.5a2.25 2.25 0 0 1 2.25 2.25v.75m-16.5 0v-2.25m16.5 0v-2.25m0 0a2.25 2.25 0 0 0-2.25-2.25h-5.25a2.25 2.25 0 0 0-1.59.659l-2.122 2.121a2.25 2.25 0 0 1-.53.22H3.75m16.5 0v6.75a2.25 2.25 0 0 1-2.25-2.25H5.25a2.25 2.25 0 0 1-2.25-2.25v-6.75m16.5 0v-2.25" />
    </svg>
);
...
export const BeakerIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c.251.023.501.05.75.082a9.75 9.75 0 0 1 8.25 9.613v1.624a.75.75 0 0 1-.75.75h-2.522a.75.75 0 0 1-.75-.75v-1.624a4.5 4.5 0 0 0-4.5-4.5v-5.714m0 0a2.25 2.25 0 0 0-2.25-2.25H5.25a2.25 2.25 0 0 0-2.25 2.25v5.714m0 0a2.25 2.25 0 0 1-2.25 2.25H1.5M5.25 14.5h.008v.008H5.25V14.5Zm2.25 0h.008v.008H7.5V14.5Zm2.25 0h.008v.008H9.75V14.5Zm2.25 0h.008v.008H12V14.5Zm2.25 0h.008v.008H14.25V14.5Zm2.25 0h.008v.008H16.5V14.5Z" />
    </svg>
);
